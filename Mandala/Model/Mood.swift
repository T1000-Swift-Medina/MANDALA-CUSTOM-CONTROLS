...
extension Mood {
    ...
    static let normal = Mood(name: "normal", image: UIImage(resource: .normal), color: UIColor.normal)
    static let fun = Mood(name: "fun", image: UIImage(resource: .fun), color: UIColor.fun)
}
